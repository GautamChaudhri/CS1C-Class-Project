 ...
 */
 ...
 int main()
 {
      ...
      *
      * @details Reads the JSON data from "/webservice/database/users.json", parses it, and returns it
      ...
      *
      * @details Accepts a POST request with JSON body and writes it to "/webservice/database/users.json".
      */
